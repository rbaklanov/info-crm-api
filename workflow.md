...
После акцепта пояснений со стороны разработчика последний должен вновь устанавливает статус задачи в `IN PROGRESS`.
...
**Что означает:** Данный статус устанавливается участником команды, ответственным за приемку задачи, если задача выполнена и оттестирована.

**Кто может устанавливать:** Team Lead, Developer, Project manager, QA Engineer.
